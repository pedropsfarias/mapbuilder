      ...
      <div class="p-fluid">
        <form @submit.prevent="addEntity">
          ...
          <div class="p-field">
            ...
            <InputText id="entity-table-name" v-model="entity.table" placeholder="Table Name" required />
          </div>
          <div class="p-field">
            <label for="entity-descritor">Atributo Descritor</label>
            <Dropdown id="entity-descritor" v-model="entity.descritor" :options="descritors" optionLabel="label"
              placeholder="Atributo Descritor" />
          </div>
          <div class="p-field">
            <label for="entity-geometry-type">Geometry Type</label>
            <Dropdown id="entity-geometry-type" v-model="entity.geometryType" :options="geometryTypes"
              optionLabel="label" placeholder="Geometry Type" />
          </div>
          <div class="p-field">
            <label for="entity-epsg">Select EPSG</label>
            <Dropdown id="entity-epsg" v-model="entity.epsg" :options="epsgs" optionLabel="label"
...
<script>
import ConfigurationLayoutComponent from '@/components/layout/ConfigurationLayoutComponent.vue';
