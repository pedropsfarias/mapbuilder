<!-- <template>
  <div class="dock">
    <div v-for="(config, i) in components" :key="i">
...
export default {
  ...
  data() {
    return {
      components: [],
      // cc: defineAsyncComponent(() => import('@/components/MeasureComponent.vue'))
    };
  },
  mounted() {
    let config = {
      ...
      component: markRaw(defineAsyncComponent(() => import('@/components/MeasureComponent.vue')))
    };
